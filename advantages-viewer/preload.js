(() => {
  ...
  const styles = ['style.css?v=89', 'alternative.css?v=91', 'viewer.css?v=89'];
  const scripts = ['viewer.js?v=84', 'recommendation-model.js?v=84', 'recommendations.js?v=91', 'app.js?v=89', 'intro.js?v=84', 'confetti.js?v=84', 'heart-balloon.js?v=84'];
