(() => {
  ...
  const styles = ['style.css?v=90', 'alternative.css?v=100', 'viewer.css?v=98'];
  const scripts = ['viewer.js?v=97', 'recommendation-model.js?v=84', 'recommendations.js?v=101', 'app.js?v=102', 'intro.js?v=100', 'confetti.js?v=84', 'heart-balloon.js?v=84'];
