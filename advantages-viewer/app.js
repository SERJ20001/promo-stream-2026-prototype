...
const hasCommission = () => paidServicesTotal(state) > 0 || state.hvatamba || state.delivery;
const commissionAmount = () => hasCommission() ? Math.floor(currentPrice() * commissionRate / 100 / 100) * 100 : 0;
